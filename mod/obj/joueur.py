...
from mod.obj.bombe import Bombe
from mod.mod_math import *

class Joueur:
	def __init__(__,x,y,max_bomb=2,max_size=2,max_size_milieu=1,telecom=0,nucleary=0, team=-1):
		__.image = pygame.image.load('datas/img/joueurs/joueur'+str(len(G.JOUEURS))+'.gif').convert()
		__.define_vars_class()
		G.JOUEURS.append(__)
		__.team = team
		__.x, __.y = x, y
		__.r = 16
	...
	def define_vars_class(__):
		__.droite, __.haut, __.gauche, __.bas, __.activ_bomb , __.lache_bomb = [
																					(100, 119, 97, 115, 101, 113),
																					(275, 273, 276, 274, 303, 279),
																					(108, 105, 106, 107, 111, 117),
